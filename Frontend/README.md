...
This is a boilerplate build with Vite, React 18, TypeScript, Vitest, Testing Library, WindiCSS, Eslint and Prettier.
...
```bash
npx degit joaopaulomoraes/reactjs-vite-windicss-boilerplate my-app
```
